...
function generateKeystore(_ref2) {
  var label = _ref2.label,
      ...
      accounts = _ref2$accounts === undefined ? _constants.DEFAULT_ACCOUNTS : _ref2$accounts;
  ...
  _ethLightwallet2.default.keystore.createVault({
    hdPathString: _constants.HD_PATH,
    password: password,
    seedPhrase: mnemonic || _bip2.default.generateMnemonic()
  }, function (err, ks) {
